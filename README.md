...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wu3kutk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wu3kutk.containers.anotherwebservice.com/
...
```
git clone git@github.com:SleggoPrime/container-wu3kutk.git
cd container-wu3kutk
```
...
```
docker attach container-wu3kutk
```
